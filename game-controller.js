...
const _BOT_LABELS = { mctsAce50: 'MCTS-ace-50', shark: 'Shark', gambler: 'Gambler',
    ...
    qstrategistmcts: 'Q-Strat-MCTS', qstrategistpure: 'Q-Strat-Pure', training: 'Training Bot', heuristic: 'Strategist', strategist2: 'Strategist 2', aggregator: 'Aggregator' };
function _makeBotEngine(key) {
    switch (key) {
        ...
        case 'strategist2': return new Strategist2Bot();         // TEST_BLOCK
        ...
        case 'aggregator': return new QStrategistAggregatorEngine();
...
function _startGame(cfgOverride = null) {
    ...
    const isTestBot   = cfg.difficulty === 'test-hybrid' || cfg.difficulty === 'test-pureq' || cfg.difficulty === 'test-training' || cfg.difficulty === 'test-ace50' || cfg.difficulty === 'test-bot-vs-bot' || cfg.difficulty === 'test-heuristic' || cfg.difficulty === 'test-strategist2' || cfg.difficulty === 'test-aggregator'; // TEST_BLOCK
    ...
    const DIFF_PROFILES = {
        ...
        'test-aggregator': [null, null,   null,       null    ], // TEST_BLOCK
    };
    ...
    else if (cfg.difficulty === 'test-aggregator') _engines[1] = new QStrategistAggregatorEngine(); // TEST_BLOCK
    ...
    // ===== TEST_BLOCK_START =====
        ...
        PLAYER_NAMES[1] = cfg.difficulty === 'test-hybrid'     ? 'Hybrid Q+MCTS'
                        ...
                        : cfg.difficulty === 'test-aggregator' ? 'Aggregator'
                        : 'Pure Q-bot';
    }
    // ===== TEST_BLOCK_END =====
